        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold text-gray-800 dark:text-gray-200">Our Location</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-semibold text-gray-800 dark:text-gray-200">Working Hours</h3>
                    <p className="text-gray-600 dark:text-gray-300 mt-1">
              ...
              {/* Social Media Links */}
              <div className="mt-8">
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4">Follow Us</h3>
                <div className="flex space-x-4">
                  <a href="https://www.instagram.com/99notes_upsc/" target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-slate-700 p-3 rounded-full hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors">
                  ...
                  <a href="https://t.me/notes99" target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-slate-700 p-3 rounded-full hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors">
                  ...
                  <a href="https://www.youtube.com/c/99Notes" target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-slate-700 p-3 rounded-full hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Our Location</h3>
              <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3602.509437354525!2d81.8465!3d25.4358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDI2JzA4LjkiTiA4McKwNTAnNDcuNCJF!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              ...
              <div key={index} className="bg-white dark:bg-slate-700 rounded-lg shadow p-6">
